...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Buscar nacionalidad de un atleta");
		System.out.println("14. Salir de la aplicación\n");
		
	}
	/**
	 * Informa al usuario sobre el pais que representa un deportista
	 */
	private void ejecutarBuscarPaisAtleta()
	{
		System.out.println("\n" + "Buscar el pais de un atleta por su nombre" + "\n");
		String nombre = input("Por favor ingrese el nombre de un atleta");
		String pais = calculadora.buscarPaisAtleta(nombre);
		if (pais == null)
		{
